...
echo "<h1>notes</h1>"
echo "<p>Project has been renamed from <strong>kurload</strong>"
echo "to <strong>termsend</strong> with v1.1.1. Downloading version v1.1.0"
echo "or earlier will result in downloading package with old name, where"
echo "all configs and init scripts are called <strong>kurload</strong>."
echo "Thus it's inadvisible to download and use version v1.1.0 or older and"
echo "they are here just for historical reasons.</p>"
