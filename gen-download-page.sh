...
echo "<h1>notes</h1>"
echo "<p><b>deb</b> comes in two files, first is <b>psmq.deb</b> which"
echo "contains tools and broker. Second file is <b>libpsmq.deb</b> which"
echo "contains psmq library. You need both for program to work</p>"
